(function ($) {
  ...
  $.fn.wPaint.menus.main = {
    img: '/res/images/canvas/icons-menu-main.png',
    items: {
       undo: {
        icon: 'generic',
        title: 'Undo',
  ...
  $.extend($.fn.wPaint.cursors, {
    'default': {path: '/res/images/canvas/cursor-crosshair.png', left: 7, top: 7},
    dropper:   {path: '/res/images/canvas/cursor-dropper.png', left: 0, top: 12},
    pencil:    {path: '/res/images/canvas/cursor-pencil.png', left: 0, top: 11.99},
    bucket:    {path: '/res/images/canvas/cursor-bucket.png', left: 0, top: 10},
    eraser1:   {path: '/res/images/canvas/cursor-eraser1.png', left: 1, top: 1},
    eraser2:   {path: '/res/images/canvas/cursor-eraser2.png', left: 2, top: 2},
    eraser3:   {path: '/res/images/canvas/cursor-eraser3.png', left: 2, top: 2},
    eraser4:   {path: '/res/images/canvas/cursor-eraser4.png', left: 3, top: 3},
    eraser5:   {path: '/res/images/canvas/cursor-eraser5.png', left: 3, top: 3},
    eraser6:   {path: '/res/images/canvas/cursor-eraser6.png', left: 4, top: 4},
    eraser7:   {path: '/res/images/canvas/cursor-eraser7.png', left: 4, top: 4},
    eraser8:   {path: '/res/images/canvas/cursor-eraser8.png', left: 5, top: 5 },
    eraser9:   {path: '/res/images/canvas/cursor-eraser9.png', left: 5, top: 5},
    eraser10:  {path: '/res/images/canvas/cursor-eraser10.png', left: 6, top: 6}
  });

  // extend defaults
  $.extend($.fn.wPaint.defaults, {
    mode:        'pencil',  // set mode
    lineWidth:   '20',       // starting line width
    fillStyle:   '#FFFFFF', // starting fill style
    strokeStyle: '#006600'  // start stroke style
  });
